...
```{r}
library(data.table)
source("https://github.com/mossnicholas/scATAC/blob/main/nucleosomes/scNuc_cluster.R")

PBMC_SMC = fread("https://github.com/mossnicholas/scATAC/tree/main/PBMC_mats/PBMC_SMC_cov_mat.txt")
...
```{r}
PBMC_cluster5 = fread("https://github.com/mossnicholas/scATAC/blob/main/PBMC_mats/PBMC_SMC_cluster5.txt")
...
```{r}
PBMC_cluster6 = fread("https://github.com/mossnicholas/scATAC/blob/main/PBMC_mats/PBMC_SMC_cluster6.txt")
